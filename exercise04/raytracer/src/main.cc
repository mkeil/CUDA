...
int main(int argc, char **argv) {
	...
	// std::cout << "Camera direction: " << s.contetCamera.direction << std::endl;	
	// std::cout << "Camera up Vektor: " << s.contetCamera.up << std::endl;	
	// std::cout << "norm(Camera direction): " << norm(s.contetCamera.direction) << std::endl;	
	
	normalize (s.contetCamera.direction);
	normalize (s.contetCamera.up);
		
	// std::cout << "normalisierte Camera direction: " << s.contetCamera.direction << std::endl;	
	// std::cout << "normalisierter Camera up Vektor: " << s.contetCamera.up << std::endl;	
